 ...
 */
public class CercleElement extends Abs_StepElement {

	
	public CercleElement(Abs_StepElement origin){
		super(origin);
	}
	 ...
	 */
	public CercleElement(MainContent mContent, Properties prop, Abs_View parent, String img) {
		//Calling parent constructor
		super(mContent, prop, parent);
	}
	
	public CercleElement(MainContent mContent, Properties prop, Abs_View parent){
		//Calling parent constructor
		super(mContent, prop, parent);
	}
	...
	public void paint(Graphics g, Point pos, Dimension dim, float scale) {
		...
		g2d.fillOval(pos.x, pos.y, dim.width, dim.height);
		
		g2d.setColor(prop.getLineColor());
		g2d.drawOval(pos.x, pos.y, dim.width, dim.height);
	}

	@Override
	public OnMouse clone() {
		return new CercleElement(this);
	}
